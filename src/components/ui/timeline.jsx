  ...
  return (
    <div className="w-full font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-black dark:text-white max-w-4xl">
          Education
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
        A quick overview of my educational path, from school to pursuing my Bachelor's degree in Computer Applications.
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 ">
              ...
              {/* Display additional fields based on available data */}
              {item.board && (
